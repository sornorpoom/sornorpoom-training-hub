...
1. **📋 หลักสูตร / ลิงก์สมัครอบรม (Training Course & Registration):** แสดงรายการหลักสูตรอบรม สถานะการรับสมัคร รูปแบบ (Online / Onsite / Hybrid) วันเวลา และพิกัดสถานที่จัดผ่าน Google Maps
2. **👥 ลิงก์รายชื่อผู้สมัคร (Applicant List):** ลิงก์ตรวจสอบรายชื่อผู้สมัครเข้ารับการอบรม
3. **✅ ลิงก์ตรวจสอบความถูกต้องของรายชื่อ (Recheck List):** ลิงก์ตรวจสอบและยืนยันความถูกต้องของรายชื่อผู้เข้ารับการอบรม (บันทึกข้อมูลที่ Column L: `Link recheck`)
4. **📚 ลิงก์เอกสารประกอบการบรรยาย (Training Materials - 2 URLs):** เชื่อมโยงเอกสาร สื่อ Canva หรือไฟล์ประกอบการอบรม
5. **🏅 ดาวน์โหลดเกียรติบัตรออนไลน์ (E-Certificate):** เชื่อมโยงระบบค้นหาและพิมพ์เกียรติบัตรอัตโนมัติ (เปิด/ปิด ได้ตามแต่ละหลักสูตร)
