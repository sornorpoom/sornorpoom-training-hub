...
ระบบรวบรวมขั้นตอนการอบรม (Training Workflow Portal Hub) เป็น Web Application สไตล์ **Minimal เชิงวิชาการ (Academic Minimal)** พัฒนาขึ้นเพื่อให้บริการและบริหารจัดการขั้นตอนการจัดอบรมสำหรับครูและบุคลากรทางการศึกษาในจังหวัดเชียงใหม่ ครอบคลุม 4 บริการหลัก:

1. **📋 หลักสูตร / รับสมัคร (Training Course):** แสดงรายการหลักสูตรอบรม สถานะการรับสมัคร รูปแบบ (Online / Onsite / Hybrid) วันเวลา และพิกัดสถานที่จัดผ่าน Google Maps
2. **📚 เอกสารประกอบการบรรยาย (Training Materials):** เชื่อมโยงเอกสาร สื่อ Canva หรือไฟล์ประกอบการอบรมแบบ Real-time
3. **📝 ตรวจสอบรายชื่อผู้มีสิทธิ์ (Check Names):** ลิงก์ตรวจสอบรายชื่อและสถานะยืนยันการเข้ารับการอบรม
4. **🏅 ดาวน์โหลดเกียรติบัตรออนไลน์ (E-Certificate):** เชื่อมโยงระบบค้นหาและพิมพ์เกียรติบัตรอัตโนมัติ
